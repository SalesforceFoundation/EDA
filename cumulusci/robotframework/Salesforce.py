...
class Salesforce(object):
    ...
    def click_affiliations_button(self, heading, button_title):
        locator = lex_locators['record']['settings']['button'].format(heading, button_title)
        self._call_selenium('_click_affiliations_button', True, locator)

    def _click_affiliations_button(self, locator):
        self.selenium.set_focus_to_element(locator)
        self.selenium.get_webelement(locator).click()
        self.wait_until_modal_is_open()
    ...
    def go_to_heda_settings(self):
        """ Navigates to the Home of the HEDA page """
        url = self.cumulusci.org.lightning_base_url
    ...
    def go_to_setup_home(self):
        """ Navigates to the Home tab of HEDA page - not the following: ... Salesforce Setup """
        url = self.cumulusci.org.lightning_base_url
        url = '{}/one/one.app#/sObject/{}/view'.format(url, obj_id)
        self.selenium.go_to(url)
        time.sleep(5)
    ...
    def _populate_system(self, locator, value):
        self.selenium.set_focus_to_element(locator)
