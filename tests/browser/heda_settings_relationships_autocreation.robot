...
Validate New Auto-Create Setting

    #Populate Object, Field, Relationship Type, Campaign Types
...
Populate Auto Create Setting
   ${object} = Generate Random String
   ${field} = Generate Random String
